...
kctl apply -f manifests/elasticsearch/es-master
...
kctl apply -f manifests/elasticsearch/es-client
kctl apply -f manifests/elasticsearch/es-data
...
kctl apply -f manifests/elasticsearch/es-curator
